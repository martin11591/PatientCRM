...
@section('content')
    ...
    <section class="per-page d-table mx-auto mt-3">
        <a @if (request()-></a>get('perPage') == 10) class="active" @endif href="?perPage=10">10</a>
        <a @if (request()->get('perPage') == 10) class="active" @endif href="?perPage=20">20</a>
        <a @if (request()->get('perPage') == 10) class="active" @endif href="?perPage=50">50</a>
        <a @if (request()->get('perPage') == 10) class="active" @endif href="?perPage=100">100</a>
    </section>
    @endif
@endsection
