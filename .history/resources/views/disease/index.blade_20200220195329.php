        ...
        @foreach ($diseases as $disease)
            <tr>
                <td class="position-relative align-middle text-center">
                    <input type="checkbox" name="id[]" form="form_multi" value="{{ $disease->id }}" id="id-{{ $disease->id }}">
                    <label class="position-absolute h-100 w-100" style="left: 0; top: 0" for="id-{{ $disease->id }}"></label>
                </td>
                <td>{{ $disease->name }}</td>
