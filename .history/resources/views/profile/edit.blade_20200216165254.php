                ...
                <div class="card-body">
                    ...
                    @endforeach
                        <div class="row">
                            ...
                            @extends('partials.modal_button', ['btn-target' => '#test1'])
                            @extends('partials.modal_content', ['modal_id' => 'test1', 'modal_title' => 'teXXXst', 'modal_content' => 'teXXst'])

                            @extends('partials.modal_button', ['btn-target' => '#test2'])
                            @extends('partials.modal_content', ['modal_id' => 'test2', 'modal_title' => 'teXXXst', 'modal_content' => 'teXXst'])
@endsection
