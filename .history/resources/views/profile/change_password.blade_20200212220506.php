...
@section('content_header')
    <h1 class="mx-0 my-3 text-dark text-center">{{ __('profile.change_password') }}</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-xs-12 col-s-8 col-md-7 col-lg-6 col-xl-5 m-auto">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('changePassword.update') }}">
                        ...
                        <div class="row my-2">
                            ...
                            <div class="row col">
                                <input type="password" id="current_password" name="current_password"  class="form-control row" />@error('current_password')
                        ...
                        <div class="row my-2">
                            ...
                            <div class="row col">
                                <input type="password" id="new_password" name="new_password"  class="form-control row" />@error('new_password')
                        ...
                        <div class="row my-2">
                            ...
                            <div class="row col">
                                <input type="password" id="repeat_password" name="new_password_confirmation"  class="form-control row" />@error('new_password_confirmation')
                                <p class="row text-danger">{{ $errors->first('new_password_confirmation') }}</p>
                            @enderror
                            </div>
                        </div>
                        <div class="row">
