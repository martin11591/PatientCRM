...
Route::prefix('/user')->name('changePassword.')->group(function() {
    Route::get('/password', 'Auth\ChangePasswordController@show')->name('changePassword.show');
    Route::put('/password', 'Auth\ChangePasswordController@update')->name('changePassword.update');
});
