...
Route::get('/profile/data/{id}', 'UserProfileController@show')->name('profile.show')->middleware('can:view,id');
Route::get('/profile/data', 'UserProfileController@show')->name('profile.show_current';
