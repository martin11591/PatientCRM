    ...
    public function destroy($disease, Request $request)
    {
        ...
        foreach ($diseases as $disease) {
            try {
                ...
                return redirect(route('disease.index'))->with('message', 'layout.delete_error' . $many, $count);
            }
        }

        return redirect(route('disease.index'))->with('message', 'layout.deleted_success' . $many, $count);
    }
}
