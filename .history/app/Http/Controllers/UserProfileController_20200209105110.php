...
class UserProfileController extends Controller
{
    public function __construct() {
        ...
        $this->user = UserProfile::findOrFail(auth()->user()->id);
    }
    /**
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(UserProfile $userProfile = $this->user)
    {
        if ($userProfile === null) $userProfile = UserProfile::findOrFail(auth()->user()->id);
    ...
    public function update(Request $request, UserProfile $userProfile)
    {
        ...
        return redirect(route('profile.show', $userProfile));
    }
