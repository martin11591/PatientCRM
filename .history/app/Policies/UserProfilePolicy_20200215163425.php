...
class UserProfilePolicy
{
     ...
     * Groups
     */
    public const SUPERUSER    = 0b1000;
    public const DOCTOR       = 0b0100;
    public const RECEPTIONIST = 0b0010;
    public const PATIENT      = 0b0001;
    ...
    private function getGroup(User $user) {
        ...
        $x = [];
        foreach ($groups as $group) $x[] = $group->name;
        dd($x);
        return null;
    }
