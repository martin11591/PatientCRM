...
class UserProfilePolicy
{
     ...
     * With this we can check if user belong to selected group or groups
     * (single group only or few groups - if more than one, then it must be all of them)
     */
    ...
    public function view(?User $user, UserProfile $userProfile)
    {
        ...
        dd(decbin($groupsID['groups']), $this->isInGroup($groupsID['groups'], self::SUPERUSER | self::DOCTOR));
        return true;
    }
