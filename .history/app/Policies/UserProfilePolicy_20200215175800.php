...
class UserProfilePolicy
{
    ...
    public function view(?User $user, UserProfile $userProfile)
    {
         ...
         */
        dd((!($this->isUserInGroup($user, self::PATIENT))) || ($this->isUserInGroup($user, self::RECEPTIONIST)) || ($this->isUserInGroup($user, self::DOCTOR)) || ($this->isUserInGroup($user, self::SUPERUSER)));
