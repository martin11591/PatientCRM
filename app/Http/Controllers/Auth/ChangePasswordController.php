...
class ChangePasswordController extends Controller
{
    ...
    public function update(Request $request) {
        ...
        $data = request()->validate([
            ...
            'new_password' => 'different:current_password|same:new_password_confirmation',
            'new_password_confirmation' => 'different:current_password|same:new_password'
        ]);
        ...
        return redirect()->back()->with('message', 'auth.password_changed_success');
    }
}
